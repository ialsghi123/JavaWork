...
<%
	...
	try{ //jsp 파일에서 예외를 반드시 catch 할 필요는 없지만..
		...
		names = multi.getParameterNames(); //일반 form paramter name들 추출
