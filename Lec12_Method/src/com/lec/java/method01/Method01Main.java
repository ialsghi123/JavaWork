...
public class Method01Main {
	...
	public static void main(String[] args) {
		...
		sayHello2("김민호",28);
		//sayHello2(10,25); //The method sayHello2(String, int) in the type Method01Main is not applicable for the arguments (int, int)
		                  // 정의된것과 다르게 호출됐을때
		
		System.out.println();
		
		sayHello3("방석민", 25); //어떤 메소드인지 알고싶을때 f3 누르면 바로 메소드로 찾아감
	...
	// 메소드 이름:sayHello
	// 매개변수:name(매개 변수가 필요 없는 경우는 생략가능) --------> 메소드는 클래스 안 메인 바깥에서 정의
