...
public class String04Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("토큰 개수"+ tokenizer1.countTokens());
		...
		System.out.println("----------------------------------");
		String str4 = "We test coders. Give us a try. Can you make it out? It's awesome.";   // - 으로 토큰분리
		...
		System.out.println("토큰 개수"+tokenizer4.countTokens());
