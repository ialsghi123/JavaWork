...
/*		title = "$ : 문자열의 마지막이 이 문자열로 마무리 됨";
		...
		arrInput = new String[] {
				...
				"xbz",				
				"xyyzx1y xyxxyxyxyxyxxy xyxyxyxyxyyyyyxxxyxyxxyxyxxxxyxy"
		};
	...
	//─────────────────────────────────────────
		...
		regex="ab{3,5}"; //b의 개수가 3개부터 5개 까지
		...
		//─────────────────────────────────────────
		title = " | : OR 연산자  역할";
		regex = "a|b"; // a또는 b둘중 하나
		arrInput = new String[] {
				"a",
				"b",
				"ab",
				"xyz",
				"abccbbcccbcaacbacbaccbccbccbcbbbccccaacccbbc"
		};
		regex="(a|b)+"; 
