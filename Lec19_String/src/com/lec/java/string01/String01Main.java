...
public class String01Main {
	...
	public static void main(String[] args) {
		...
		str1 = str1.concat(str2); // 변경ㅎ려면 이와 같이 덮어쓰기 해야 한다
		...
		// System.out.println(str1.charAt(20)); 너무 큰값을 대입하면 죽음
		...
		String str4 = "We test coders. Give us a try. Can you make it out? It's awesome.";
		...
		str4="We test coders. Give us a try. Can you make it out? It's awesome.";
