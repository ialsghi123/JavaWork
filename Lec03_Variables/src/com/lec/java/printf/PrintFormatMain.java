...
public class PrintFormatMain {
	...
	public static void main(String[] args) {
		System.out.println("서식화된 출력:prinf(), String.format()");
		
		double pi = Math.PI; //원주율 값
		System.out.println(pi);
		
		//printf:printf with format
		//prinf("서식문자열",값1,값2...)
		...
		System.out.printf("|%5d|%5d|%5d|\n",100,200,300); //우측정렬(기본) 출력폭 5칸
		System.out.printf("|%-5d|%-5d|%-5d|\n",100,200,300);
		
		System.out.printf("제 이름은 [%5s]입니다. 혈액형은 %c형 입니다.\n","봉준호",'B');
		...
		//String.format()
		String.format("합격률은 %1.f%% 입니다",rate);
