...
public class Collection14Main {
	...
	public static void main(String[] args) throws ParseException {
		...
		List<String> arrList=Arrays.asList(arr); //배열 -->List<> 로 변환 (List<>의 toArray()와 반대)
		Collections.shuffle(arrList);
		
		arrList=arrList.subList(0,3); //index 0부터 3천까지 List<> 생성
...
//Student를 이름(name)으로 정렬해줄수 있는 Comparator<> 제공
